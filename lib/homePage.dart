...
class _HomeState extends State<Home> {
  ...
  getNewsByQuery(String query) async {
    ...
    String topApi="https://newsapi.org/v2/top-headlines?country=in&";
    Map element;
    int i = 0;
    String url =topApi+category+"apiKey=0780ae6e79a6458f9336fbc9e1777d88";


        // "https://newsapi.org/v2/top-headlines?q=$query&sources=google-news-in&&apiKey=9bb7bf6152d147ad8ba14cd0e7452f2f";
  ...
  getNewsofIndia() async {
    String url =
        "https://newsapi.org/v2/top-headlines?sources=google-news-in&apiKey=0780ae6e79a6458f9336fbc9e1777d88";
    Response response = await get(Uri.parse(url));
    Map data = jsonDecode(response.body);
    setState(() {
